...
test.describe("Navigation - E2E Tests", () => {
  ...
  test("should navigate from Unicode page to WHOIS page via category dropdown", async ({
    page,
  }) => {
  ...
  test("should navigate from WHOIS page to Unicode page via category dropdown", async ({
    page,
  }) => {
  ...
  test("should navigate from Unicode page to IP検索 page via category dropdown", async ({
    page,
  }) => {
    await page.goto("/unicode", { waitUntil: "domcontentloaded" });
  ...
  test("should navigate from Unicode page to グローバルIP page via category dropdown", async ({
    page,
  }) => {
    await page.goto("/unicode", { waitUntil: "domcontentloaded" });
  ...
  test("should navigate from グローバルIP page to WHOIS page via category dropdown", async ({
    page,
  }) => {
  ...
  test("should navigate from Unicode page to UUID生成 page via category dropdown", async ({
    page,
  }) => {
    await page.goto("/unicode", { waitUntil: "domcontentloaded" });
  ...
  test("should navigate from UUID生成 page to WHOIS page via category dropdown", async ({
    page,
  }) => {
  ...
  test("should navigate from Unicode page to サーバー環境 page via category dropdown", async ({
    page,
  }) => {
    await page.goto("/unicode", { waitUntil: "domcontentloaded" });
  ...
  test("should navigate from サーバー環境 page to WHOIS page via category dropdown", async ({
    page,
  }) => {
