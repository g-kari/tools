...
function createMinimalJpeg(): ArrayBuffer {
  const bytes = new Uint8Array([
    0xff, 0xd8, // SOI
    0xff, 0xe0, // APP0
    0x00, 0x10, // APP0 長さ (16)
    0x4a, 0x46, 0x49, 0x46, 0x00, // "JFIF\0"
    0x01, 0x01, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, // JFIF データ
    0xff, 0xd9, // EOI
  ]);
  return bytes.buffer;
}
 ...
 */
function createJpegWithExif(makeStr: string = 'TestMake', modelStr: string = 'TestModel'): ArrayBuffer {
  ...
  const jpeg = new Uint8Array([
    0xff, 0xd8,             // SOI
    0xff, 0xe1,             // APP1
    (app1Length >> 8) & 0xff, app1Length & 0xff, // 長さ
    ...app1Data,
    0xff, 0xda,             // SOS (以降はデータとみなす)
    0x00,                   // ダミーデータ
  ]);
...
describe('groupEntriesByCategory', () => {
  ...
  it('カテゴリに応じて正しくグループ化される', () => {
    const entries = [
      ...
      { tag: '撮影日時', tagId: 0x9003, value: '2024:01:01 12:00:00', category: 'datetime' as const },
