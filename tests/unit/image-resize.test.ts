...
import { formatFileSize, calculateAspectRatioSize, clampDimension } from "../../app/utils/image";
...
describe("Image Resize", () => {
  ...
  describe("generateFilename", () => {
    ...
    it("should handle multiple dots in filename", () => {
      expect(generateFilename("my.photo.file.jpeg", 640, 480, false)).toBe(
        "my.photo.file_resized_640x480.jpeg",
      );
    });
    ...
    it("should handle filenames with special characters", () => {
      expect(generateFilename("photo-2024_01.jpg", 400, 300, false)).toBe(
        "photo-2024_01_resized_400x300.jpg",
      );
    });
  });
  ...
  describe("Size constraints", () => {
    ...
    it("should validate dimensions within bounds", () => {
      const isValid = (value: number) => value >= MIN_DIMENSION && value <= MAX_DIMENSION;
