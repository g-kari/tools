...
describe('detectLanguage', () => {
  ...
  it('日本語テキストを日本語と判定', () => {
    expect(detectLanguage('これはテストです。日本語のテキストを入力してください。')).toBe('japanese');
  });
...
describe('analyzeReadability', () => {
  it('英語テキストで english 言語を返す', () => {
    const result = analyzeReadability('Hello world. This is a test sentence for readability analysis.');
