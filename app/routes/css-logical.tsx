...
function CssLogicalPage() {
  ...
  const filteredPropMap = useMemo(() => {
    return Object.entries(PROPERTY_MAP).filter(([prop]) => categorize(prop) === activeRefTab);
  }, [activeRefTab]);
      ...
      <div className="cssl-editor-grid">
        ...
        <div className="cssl-panel">
          <div className="cssl-panel-header">
            ...
            <span className="cssl-stats">{inputCss.split("\n").length} 行</span>
          </div>
          <textarea
            id="cssl-input"
        ...
        <div className="cssl-panel">
          <div className="cssl-panel-header">
            ...
            <span
              ...
              aria-live="polite"
            >
              {result.changedCount > 0 ? `${result.changedCount} 件変換` : "変換なし"}
            </span>
          </div>
          <div className="cssl-output" role="region" aria-label="変換結果" aria-live="polite">
          ...
          <table className="cssl-ref-table">
            <thead>
              <tr>
                ...
                <th scope="col" className="prop-arrow">
                  →
                </th>
