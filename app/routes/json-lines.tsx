  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          'JSON Lines（NDJSON）の解析・整形・バリデーション。JSON配列との相互変換も可能。',
      },
...
function JsonLinesPage() {
  ...
  const handleLoadSample = useCallback(() => {
    const sample =
      mode === 'from-array' ? SAMPLE_JSON_ARRAY : SAMPLE_JSONL;
    setInputText(sample);
    setOutputText('');
    setError(null);
      ...
      <div className="tool-container">
        ...
        >
          ...
          <Button
            type="button"
            className={
              mode === 'from-array' ? 'btn-primary' : 'btn-secondary'
            }
            onClick={() => {
              setMode('from-array');
              setInputText('');
        ...
        >
          ...
          <div className="converter-section">
            ...
            <Textarea
              ...
              aria-label={
                mode === 'from-array' ? 'JSON配列入力欄' : 'JSON Lines入力欄'
              }
            />
          </div>
          ...
          {mode === 'validate' && parseResult && (
            <div className="jsonl-stats" aria-live="polite" aria-label="バリデーション統計">
              <div className="jsonl-stat-item">
                ...
                <span className="jsonl-stat-value jsonl-stat-valid">
              ...
              <div className="jsonl-stat-item">
                ...
                <span className="jsonl-stat-value">
                  {parseResult.emptyCount}
                </span>
              </div>
            </div>
          )}
                  ...
                  {parseResult.lines
                    ...
                    .map((l) => (
                      <li key={l.lineNumber} className="jsonl-error-item">
                        <span className="jsonl-error-line">
                          行 {l.lineNumber}:
                        </span>{' '}
