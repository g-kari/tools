...
import { validateCard, TEST_CARD_NUMBERS, type LuhnResult } from "../utils/luhn";
  ...
  return (
    <>
      <div className="luhn-container">
        ...
        <section className="luhn-input-section" aria-labelledby="luhn-heading">
          ...
          {showDetails && (
            ...
            >
              ...
              {result.cardType && <BrandIcon brand={result.cardType.brand} />}
            </div>
          )}
        </section>
        ...
        {/* 詳細情報 */}
        {showDetails && (
          <section className="luhn-details-section" aria-labelledby="luhn-details-heading">
            ...
            <div className="luhn-details-grid">
              ...
              <div className="luhn-detail-card">
                ...
                <div className={`luhn-detail-value ${result.isValid ? "valid" : "invalid"}`}>
              ...
              <div className="luhn-detail-card">
                ...
                <div className={`luhn-detail-value ${result.isValidLength ? "valid" : "invalid"}`}>
                  {result.digits.length}桁{result.isValidLength ? " ✓" : " ✗"}
                </div>
              </div>
              ...
              <div className="luhn-detail-card">
                ...
                <div className="luhn-detail-value">{result.digits.slice(0, 6) || "—"}</div>
              </div>
            </div>
          </section>
        )}
        ...
        {/* テスト番号リスト */}
        <section className="luhn-test-section" aria-labelledby="luhn-test-heading">
