...
const navCategories = [
  {
    ...
    items: [
      ...
      { path: "/quoted-printable", label: "Quoted-Printableエンコード" },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/gitattributes", label: ".gitattributes生成" },
      { path: "/editorconfig", label: "EditorConfigジェネレーター" },
      { path: "/makefile", label: "Makefileジェネレーター" },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/exif-viewer", label: "EXIFビューワー" },
      ...
      { path: "/css-logical", label: "CSS 論理プロパティ変換" },
    ],
  },
  {
    name: "カラー",
    ...
    items: [
      ...
      { path: "/tailwind-colors", label: "Tailwind CSSカラーリファレンス" },
    ],
  },
  {
    name: "検索",
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/beaufort", label: "ボーフォート暗号" },
      { path: "/playfair", label: "プレイフェア暗号" },
      { path: "/atbash", label: "アトバシュ暗号" },
