      ...
      <div className="tool-container">
        <form onSubmit={e => e.preventDefault()} aria-label="HTML フォーマットフォーム">
                ...
                <div className="csv-json-mode-group" role="group">
                  <label className="format-option">
                    <input
                      ...
                      onChange={() => { setUseTabs(false); setIndentSize(2); }}
                      aria-label="2スペース"
                    />
                  ...
                  <label className="format-option">
                    <input
                      ...
                      onChange={() => { setUseTabs(false); setIndentSize(4); }}
                      aria-label="4スペース"
                    />
          ...
          <div className="button-group" role="group" aria-label="操作">
            <Button type="button" className="btn-primary" onClick={handleFormat} aria-label="HTML を整形">
              整形
            </Button>
            <Button type="button" variant="outline" onClick={handleSample} aria-label="サンプル HTML をセット">
              サンプル
            </Button>
