  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Base16 (Hex) エンコード・デコード | Web ツール集" },
      {
        ...
        content:
          "テキストを Base16（16進数）にエンコード・デコード。大文字/小文字・区切り文字オプション対応。",
      },
      ...
      <div className="tool-container">
        ...
        {mode === "decode" && decodeError && input.trim() && (
          <div className="b16-error" role="alert" aria-label="デコードエラー">
            <span className="b16-error-icon" aria-hidden="true">
              ⚠
            </span>
            {decodeError}
          </div>
          ...
          <div className="converter-section">
            <div className="b16-output-header">
              ...
              {mode === "decode" && decodeResult && (
                <span className="b16-output-meta">{decodeResult.bytes.length} バイト</span>
              )}
            </div>
            <textarea
