  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Base36エンコード・デコード | Web ツール集" },
      {
        ...
        content:
          "Base36エンコード・デコード。JavaScript の Number.toString(36) と互換の英数字エンコード方式。",
      },
      ...
      { name: "twitter:title", content: "Base36エンコード・デコード | Web ツール集" },
      {
        ...
        content:
          "Base36エンコード・デコード。短い ID・ライセンスキー生成に使われる英数字エンコード方式。",
      },
    ],
  }),
      ...
      <div className="tool-container">
        ...
        {errorMessage && input.trim() && (
          <div className="b36-error" role="alert" aria-label="エラー">
            <span className="b36-error-icon" aria-hidden="true">
              ⚠
            </span>
            {errorMessage}
          </div>
          ...
          <div className="converter-section">
            <div className="b36-output-header">
              ...
              {inputMode === "text" && mode === "decode" && decodeResult && (
                <span className="b36-output-meta">{decodeResult.bytes.length} バイト</span>
              )}
            </div>
            {inputMode === "text" ? (
              <textarea
