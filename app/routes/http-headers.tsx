...
export const HTTP_HEADERS: HttpHeader[] = [
  ...
  },
  {
    ...
    category: 'response',
    description:
      'プロキシキャッシュにオブジェクトが格納されてからの経過時間（秒）を示します。',
    example: 'Age: 3600',
    security: false,
  },
  {
  ...
  },
  {
    ...
    example:
      'Link: <https://example.com/style.css>; rel="stylesheet", </next>; rel="next"',
    security: false,
  },
  {
    name: 'Location',
  ...
  // ===== 共通ヘッダー =====
  {
    ...
    category: 'general',
    description:
      'メッセージが生成された日時を示します。RFC 7231形式（IMF-fixdate）で記述します。',
...
function HttpHeadersPage() {
  ...
  const handleTabChange = useCallback(
    (tab: FilterTab) => {
      ...
      announceStatus(
        `${CATEGORY_LABELS[tab]} でフィルタリング。${count} 件表示`
      );
    },
  ...
  return (
    <>
      <div className="tool-container">
        ...
        {/* カテゴリフィルター */}
        <div
          className="http-headers-filters"
          role="group"
            ...
            {filtered.map((header) => (
              ...
              >
                ...
                <div className="http-headers-example">
                  ...
                  <code className="http-headers-example-value">
                    {header.example}
                  </code>
                </div>
