...
export const MIME_TYPES: MimeType[] = [
  ...
  },
  {
    ...
    extensions: [".xml"],
    description: "XML形式のデータ。設定ファイルや古いSOAP APIのレスポンスに使用されます。",
    category: "application",
  },
  {
    type: "application/pdf",
    extensions: [".pdf"],
    description: "PDFドキュメント。電子文書の配布や帳票出力に広く使用されます。",
    category: "application",
  },
  {
    type: "application/zip",
    extensions: [".zip"],
    description: "ZIP圧縮アーカイブ。複数ファイルをまとめてダウンロード配布する際に使用します。",
    category: "application",
  },
  {
  ...
  },
  {
    ...
    extensions: [".tar"],
    description: "TARアーカイブ。複数ファイルをまとめてアーカイブする際に使用（主にLinux）。",
    category: "application",
  },
  {
  ...
  },
  {
    ...
    extensions: [],
    description: "HTMLフォームのデフォルトエンコーディング。キー=値ペアのURLエンコード形式で送信。",
    category: "application",
  },
  {
  ...
  },
  {
    ...
    extensions: [".jsonld"],
    description: "JSON-LD（Linked Data）形式。SEO向け構造化データのマークアップに使用。",
    category: "application",
  },
  {
  ...
  },
  {
    ...
    extensions: [".rss"],
    description: "RSSフィード。ブログやニュースサイトの更新通知配信に使用。",
    category: "application",
  },
  {
  ...
  },
  {
    ...
    extensions: [".xls"],
    description: "Microsoft Excel 旧形式（.xls）のスプレッドシートファイル。",
    category: "application",
  },
  {
    type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
    extensions: [".xlsx"],
    description: "Microsoft Excel 現行形式（.xlsx）のスプレッドシートファイル。",
    category: "application",
  },
  {
  ...
  },
  {
    ...
    extensions: [".ppt"],
    description: "Microsoft PowerPoint 旧形式（.ppt）のプレゼンテーションファイル。",
    category: "application",
  },
  {
    type: "application/vnd.openxmlformats-officedocument.presentationml.presentation",
    extensions: [".pptx"],
    description: "Microsoft PowerPoint 現行形式（.pptx）のプレゼンテーションファイル。",
    category: "application",
  },
  {
  ...
  // text
  {
    type: "text/html",
    extensions: [".html", ".htm"],
    description: "HTMLドキュメント。Webページのマークアップ言語。ブラウザが解釈・描画します。",
    category: "text",
  },
  {
    type: "text/css",
    extensions: [".css"],
    description: "CSSスタイルシート。Webページの見た目（色・レイアウト等）のスタイル定義。",
    category: "text",
  },
  {
    type: "text/javascript",
    extensions: [".js", ".mjs"],
    description: "JavaScriptファイル。ブラウザで実行されるスクリプト（現在はこちらが推奨仕様）。",
    category: "text",
  },
  {
    type: "text/plain",
  ...
  },
  {
    type: "text/csv",
    extensions: [".csv"],
    description: "CSV（カンマ区切り値）形式。スプレッドシートや表形式データの交換に広く使用。",
    category: "text",
  },
  {
    type: "text/xml",
    extensions: [".xml"],
    description: "XML形式のテキスト。設定ファイルや構造化データに使用（application/xmlと等価）。",
    category: "text",
  },
  {
    type: "text/markdown",
    extensions: [".md", ".markdown"],
    description: "Markdown形式のテキスト。README・ドキュメント・ブログ記事等に使用。",
    category: "text",
  },
  {
    type: "text/calendar",
    extensions: [".ics"],
    description: "iCalendar形式。カレンダーイベントの交換・インポートに使用。",
    category: "text",
  },
  {
    type: "text/vcard",
    extensions: [".vcf"],
    description: "vCard形式。連絡先情報（氏名・電話・メール等）の交換に使用。",
    category: "text",
  },
  {
  ...
  },
  {
    ...
    extensions: [".tsv"],
    description: "TSV（タブ区切り値）形式。スプレッドシートデータのCSV代替形式。",
    category: "text",
  },
  {
    type: "text/uri-list",
    extensions: [".uri", ".uris", ".urls"],
    description: "URIリスト形式。ドラッグ&ドロップ時のURL受け渡しや複数URLの記述に使用。",
    category: "text",
  },
  ...
  },
  {
    type: "image/png",
    extensions: [".png"],
    description: "PNG画像。透過対応の可逆圧縮形式。ロゴ・スクリーンショット・アイコンに最適。",
    category: "image",
  },
  {
    type: "image/gif",
    extensions: [".gif"],
    description: "GIF画像。アニメーション対応の256色画像形式。シンプルなアニメーションに使用。",
    category: "image",
  },
  {
    type: "image/webp",
  ...
  },
  {
    type: "image/avif",
    extensions: [".avif"],
    description: "AVIF画像。WebPよりもさらに高い圧縮率を実現する最新の画像形式（AV1ベース）。",
    category: "image",
  },
  {
    type: "image/svg+xml",
  ...
  },
  {
    type: "image/x-icon",
    extensions: [".ico"],
    description: "ICOファイル。ブラウザのfavicon（タブアイコン）やデスクトップアイコンに使用。",
    category: "image",
  },
  {
    type: "image/bmp",
  ...
  },
  {
    type: "image/tiff",
    extensions: [".tif", ".tiff"],
    description: "TIFF画像。高品質の印刷・スキャン・写真編集用画像形式。",
    category: "image",
  },
  {
    type: "image/heic",
    extensions: [".heic", ".heif"],
    description: "HEIC/HEIF画像。iPhoneのデフォルト高効率画像形式（iOS 11以降）。",
    category: "image",
  },
  ...
  // audio
  {
    type: "audio/mpeg",
    extensions: [".mp3"],
    description: "MP3音声。最も広く使われる音声圧縮形式。互換性が高くあらゆる環境で再生可能。",
    category: "audio",
  },
  {
    type: "audio/ogg",
    extensions: [".ogg", ".oga"],
    description: "Ogg音声コンテナ。オープンソースのVorbisやOpusコーデックを含む音声形式。",
    category: "audio",
  },
  {
    type: "audio/wav",
    extensions: [".wav"],
    description: "WAV音声。非圧縮の高品質音声形式。ファイルサイズが大きいが品質は最高。",
    category: "audio",
  },
  {
    type: "audio/aac",
    extensions: [".aac"],
    description: "AAC音声。MP3の後継となる高効率音声圧縮形式。iOSやiTunesで標準採用。",
    category: "audio",
  },
  {
    type: "audio/flac",
    extensions: [".flac"],
    description: "FLAC音声。可逆圧縮の高品質音声形式。圧縮しても音質が劣化しない。",
    category: "audio",
  },
  {
    type: "audio/webm",
    extensions: [".weba"],
    description: "WebM音声コンテナ。Web向けのオープン音声形式（OpusまたはVorbis）。",
    category: "audio",
  },
  {
    type: "audio/midi",
    extensions: [".mid", ".midi"],
    description: "MIDI音声。電子楽器の演奏データ形式。音声波形ではなく音符情報を格納。",
    category: "audio",
  },
  {
    type: "audio/opus",
    extensions: [".opus"],
    description: "Opus音声。低遅延・高品質のオープン音声コーデック。VoIPやWebRTCに最適。",
    category: "audio",
  },
  ...
  // video
  {
    type: "video/mp4",
    extensions: [".mp4", ".m4v"],
    description: "MP4動画。最も広く使われる動画コンテナ形式（H.264/H.265コーデック）。",
    category: "video",
  },
  {
    type: "video/webm",
    extensions: [".webm"],
    description: "WebM動画。Web向けのオープン動画形式（VP8/VP9/AV1コーデック）。",
    category: "video",
  },
  {
    type: "video/ogg",
    extensions: [".ogv"],
    description: "Ogg動画コンテナ。オープンソースのTheoraコーデックを含む動画形式。",
    category: "video",
  },
  {
    type: "video/quicktime",
    extensions: [".mov"],
    description: "QuickTime動画。AppleのQuickTimeプレーヤー向けコンテナ形式。",
    category: "video",
  },
  {
    type: "video/x-msvideo",
    extensions: [".avi"],
    description: "AVI動画。Microsoftの旧来の動画コンテナ形式。互換性は高いが効率は低い。",
    category: "video",
  },
  {
    type: "video/mpeg",
    extensions: [".mpeg", ".mpg"],
    description: "MPEG動画。旧来の動画圧縮規格（MPEG-1/MPEG-2）。DVDやデジタル放送に使用。",
    category: "video",
  },
  {
    type: "video/3gpp",
    extensions: [".3gp"],
    description: "3GP動画。モバイル向けの動画コンテナ形式（主にAndroid/フィーチャーフォン）。",
    category: "video",
  },
  ...
  },
  {
    type: "font/otf",
    extensions: [".otf"],
    description: "OpenTypeフォント。TrueTypeを拡張した現行フォント規格。高度な組版機能を持つ。",
    category: "font",
  },
  {
    type: "font/collection",
    extensions: [".ttc"],
    description: "TrueType Collection。複数のフォントを1ファイルにまとめたコレクション形式。",
    category: "font",
  },
 ...
 */
export function filterMimeTypes(types: MimeType[], query: string, category: string): MimeType[] {
  ...
  return (
    <>
      <div className="tool-container">
        ...
        {/* カテゴリフィルタ */}
        <div className="mime-filters" role="group" aria-label="カテゴリフィルター">
          {CATEGORIES.map((cat) => (
            <button
              key={cat}
              type="button"
        ...
        {/* 件数表示 */}
        <p className="mime-count" role="status" aria-live="polite" aria-atomic="true">
          {filteredTypes.length} 件 / 全 {MIME_TYPES.length} 件
        </p>

        {/* グリッド表示 */}
        {filteredTypes.length > 0 ? (
          <div className="mime-grid" role="list" aria-label="MIMEタイプ一覧">
