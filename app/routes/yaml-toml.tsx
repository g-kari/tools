  ...
  head: () => ({
    meta: [
      ...
      { property: 'og:title', content: 'YAML↔TOML変換ツール | Web ツール集' },
      {
        ...
        content: 'YAML と TOML を直接相互変換。Cargo.toml・pyproject.toml・GitHub Actions 設定ファイルの変換に。',
      },
        ...
        <form onSubmit={e => e.preventDefault()} aria-label="YAML/TOML変換フォーム">
          ...
          <div className="converter-section">
            ...
            <Textarea
              ...
              aria-label={
                mode === 'yaml-to-toml' ? '変換元の YAML テキスト入力欄' : '変換元の TOML テキスト入力欄'
              }
          ...
          <div className="button-group" role="group" aria-label="変換操作">
            <Button type="button" className="btn-primary" onClick={handleConvert} aria-label={convertLabel}>
              {convertLabel}
            </Button>
            <Button type="button" variant="outline" className="btn-clear" onClick={handleClear} aria-label="入力と出力をクリア">
              クリア
            </Button>
          </div>
          ...
          <div className="output-section">
            ...
            <Textarea
              ...
              aria-label={mode === 'yaml-to-toml' ? 'TOML 変換結果の出力欄' : 'YAML 変換結果の出力欄'}
              aria-live="polite"
              className="csv-json-textarea"
            />
          </div>
