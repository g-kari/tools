  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          'Nginx サーバーブロックの設定を GUI で生成するツール。',
      },
    ],
  }),
...
function NginxConfigPage() {
  ...
  const [config, setConfig] = useState<NginxServerConfig>(() =>
    getDefaultConfig()
  );
  ...
  /** ヘッダー設定を部分的に更新するヘルパー */
  const updateHeaders = (
    patch: Partial<NginxServerConfig['headers']>
  ) => {
    setConfig((prev) => ({
      ...prev,
  ...
  return (
    <>
      <div className='ngx-container'>
        ...
        {/* サーバータイプ選択 */}
        <section
          className='ngx-section'
          aria-labelledby='ngx-server-type-heading'
        >
          <h2 id='ngx-server-type-heading' className='ngx-section-title'>
            サーバータイプ
          </h2>
          <div
            className='ngx-radio-group'
            role='radiogroup'
            aria-label='サーバータイプ'
          >
            {(
        ...
        <section
          className='ngx-section'
          aria-labelledby='ngx-basic-heading'
        >
          ...
          <div className='ngx-grid-2'>
            <div className='ngx-field'>
              ...
              <input
                ...
                max={65535}
                onChange={(e) =>
                  updateConfig({ port: parseInt(e.target.value, 10) || 80 })
                }
            ...
            <div className='ngx-field'>
              ...
              <input
                ...
                onChange={(e) =>
                  updateConfig({ clientMaxBodySize: e.target.value })
                }
                placeholder='10m'
        ...
        {config.serverType !== 'redirect' && (
          <section
            className='ngx-section'
            aria-labelledby='ngx-ssl-heading'
          >
        ...
        {config.serverType === 'static' && (
          <section
            className='ngx-section'
            aria-labelledby='ngx-content-heading'
          >
        ...
        {config.serverType === 'proxy' && (
          <section
            className='ngx-section'
            aria-labelledby='ngx-proxy-heading'
          >
            ...
            <label className='ngx-checkbox-row'>
              <input
                ...
                onChange={(e) =>
                  updateConfig({ proxyBuffering: e.target.checked })
                }
        ...
        {config.serverType === 'redirect' && (
          <section
            className='ngx-section'
            aria-labelledby='ngx-redirect-heading'
          >
        ...
        {config.serverType !== 'redirect' && (
          <section
            className='ngx-section'
            aria-labelledby='ngx-perf-heading'
          >
            ...
            <label className='ngx-checkbox-row'>
              <input
                ...
                onChange={(e) =>
                  updateConfig({ cacheStaticAssets: e.target.checked })
                }
        ...
        {config.serverType !== 'redirect' && (
          <section
            className='ngx-section'
            aria-labelledby='ngx-headers-heading'
          >
            ...
            <div className='ngx-field'>
              ...
              <select
                ...
                onChange={(e) =>
                  updateHeaders({
                    xFrameOptions: e.target.value as
                      | 'DENY'
                      | 'SAMEORIGIN'
                      | 'none',
                  })
            ...
            <div className='ngx-field'>
              ...
              <select
                ...
                onChange={(e) =>
                  updateHeaders({ referrerPolicy: e.target.value })
                }
            ...
            <label className='ngx-checkbox-row'>
              <input
                ...
                onChange={(e) =>
                  updateHeaders({ xContentTypeOptions: e.target.checked })
                }
            ...
            <label className='ngx-checkbox-row'>
              <input
                ...
                onChange={(e) =>
                  updateHeaders({ xssProtection: e.target.checked })
                }
            ...
            <label className='ngx-checkbox-row'>
              <input
                ...
                disabled={!config.ssl}
                onChange={(e) =>
                  updateHeaders({ hsts: e.target.checked })
                }
                aria-label='HSTS ヘッダーを付与する（SSL 必須）'
              />
              HSTS: Strict-Transport-Security
              {!config.ssl && (
                <span className='ngx-placeholder'>（SSL 有効時のみ）</span>
              )}
            </label>
          </section>
        )}
        ...
        <section
          className='ngx-section'
          aria-labelledby='ngx-output-heading'
        >
          ...
          <div className='ngx-output-wrapper'>
            <pre
              className='ngx-code-block'
              aria-label='生成された Nginx 設定'
              aria-live='polite'
            >
