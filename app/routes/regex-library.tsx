  ...
  return (
    <>
      <div className="tool-container">
        ...
        {/* 件数表示 */}
        <p className="regex-lib-count" role="status" aria-live="polite" aria-atomic="true">
        ...
        {filteredEntries.length > 0 ? (
          <div className="regex-lib-grid" role="list" aria-label="正規表現パターン一覧">
            {filteredEntries.map((entry) => {
              ...
              const testResult =
                testInput !== ""
                  ? testRegex(entry.pattern, entry.flags.replace("g", ""), testInput)
                  : null;
                ...
                >
                  ...
                  <div className="regex-lib-examples">
                    <div className="regex-lib-examples-row">
                      ...
                      <div
                        className="regex-lib-example-chips"
                        role="list"
                        aria-label="マッチする例"
                      >
                    ...
                    <div className="regex-lib-examples-row">
                      <span
                        className="regex-lib-examples-label no-match"
                        aria-label="マッチしない例"
                      >
                        ✗
                      </span>
                  ...
                  <div className="regex-lib-test-area">
                    ...
                    <div className="regex-lib-test-input-row">
                      ...
                      <span
                        ...
                        aria-live="polite"
                        aria-label={
                          testResult === null ? "入力待ち" : testResult ? "マッチ" : "マッチなし"
                        }
                      >
