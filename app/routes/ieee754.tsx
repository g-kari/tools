  ...
  const handleHexInput = useCallback(
    (str: string) => {
      ...
      if (clean.length > expectedLength) {
        setParseError(`${precision === "float32" ? "8" : "16"}文字以内で入力してください`);
        return;
      }
      ...
      <div className="tool-container">
        ...
        <div className="f754-bits-section">
          <div className="f754-bits-legend" aria-hidden="true">
            ...
            <span className="f754-legend-exp">指数部 ({expBitsCount} bits)</span>
            <span className="f754-legend-mant">仮数部 ({totalBits - 1 - expBitsCount} bits)</span>
          </div>
        ...
        <div className="f754-info-grid">
          ...
          <div className="f754-info-card">
            ...
            <div className="f754-info-value f754-info-value-base">0x{result.hexRepresentation}</div>
          ...
          <div className="f754-info-card">
            ...
            <div className="f754-breakdown">
              <div className="f754-breakdown-row">
                ...
                <div className="f754-breakdown-content">
                  <span className="f754-breakdown-bits">{result.exponentBits.join("")}</span>
                  <span className="f754-breakdown-value">= {result.exponentRaw} (10進数)</span>
                </div>
              </div>
              <div className="f754-breakdown-row">
              ...
              <div className="f754-breakdown-row">
                ...
                <div className="f754-breakdown-content">
                  <span className="f754-breakdown-bits">
                    {result.isSubnormal
                      ? `1 - ${result.exponentBias}`
                      : `${result.exponentRaw} - ${result.exponentBias}`}{" "}
                    = {result.exponentActual}
                  </span>
                  {result.isSubnormal && <span className="f754-breakdown-value">※ 非正規化数</span>}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="f754-info-card">
            ...
            <div className="f754-breakdown">
              <div className="f754-breakdown-row">
                <span className="f754-breakdown-label">ビット列</span>
                <div className="f754-breakdown-content">
                  <span className="f754-breakdown-bits f754-breakdown-bits-xs">
              ...
              <div className="f754-breakdown-row">
                ...
                <div className="f754-breakdown-content">
                  ...
                  <span className="f754-breakdown-value">
                    ≈{" "}
                    {result.isSubnormal
                      ? result.mantissaFraction.toExponential(4)
                      : (1 + result.mantissaFraction).toFixed(8)}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="f754-info-card f754-formula-card">
            ...
            {!result.isNaN && !result.isInfinity && !result.isZero && (
              <div className="f754-info-sub f754-info-sub-mt2">
                (-1)^{result.signBit} × 2^{result.exponentActual} × {result.isSubnormal ? "0" : "1"}
                .fraction
              </div>
            )}
          </div>
