  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          'MOD-97アルゴリズムでIBAN国際銀行口座番号を検証。80カ国以上に対応。',
      },
  ...
  return (
    <>
      <div className="iban-container">
        ...
        <section className="iban-input-section" aria-labelledby="iban-heading">
          ...
          {showDetails && (
            <div
              ...
              aria-label="IBAN検証結果"
            >
              <span className="iban-result-icon">
                {isOverallValid ? '✓' : '✗'}
              </span>
        ...
        {showDetails && (
          <section
            className="iban-details-section"
            aria-labelledby="iban-details-heading"
          >
            ...
            <div className="iban-details-grid">
              ...
              <div className="iban-detail-card">
                ...
                <div
                  className={`iban-detail-value ${result.isValid ? 'valid' : 'invalid'}`}
                >
              ...
              <div className="iban-detail-card">
                ...
                <div
                  className={`iban-detail-value ${result.isValidLength ? 'valid' : 'invalid'}`}
                >
                  {result.normalized.length}桁
        ...
        {/* テスト番号セクション */}
        <section
          className="iban-test-section"
          aria-labelledby="iban-test-heading"
        >
          ...
          <div className="iban-test-table-wrapper">
            <table
              className="iban-test-table"
              aria-label="テスト用IBAN番号一覧"
            >
              <thead>
                <tr>
                  <th scope="col">国</th>
