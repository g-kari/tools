        ...
        >
              ...
              <div className="csv-json-options">
                <div className="option-group">
                  ...
                  <div
                    className="csv-json-mode-group"
                    role="group"
                    aria-labelledby="graphql-indent-option-label"
                  >
                    <label className="format-option">
                      <input
                        type="radio"
          ...
          <div className="converter-section">
            ...
            <Textarea
              ...
              aria-describedby="graphql-input-help"
              aria-label="変換元の GraphQL テキスト入力欄"
              className="csv-json-textarea graphql-textarea"
            />
            <span id="graphql-input-help" className="sr-only">
              GraphQL クエリやスキーマを入力して操作ボタンを押してください
            </span>
          </div>

          <div className="button-group" role="group" aria-label="GraphQL 操作">
            <Button
              type="button"
              className="btn-primary"
              onClick={handleProcess}
              aria-label={`GraphQL ${processLabel}`}
            >
              {processLabel}
            </Button>
            <Button
