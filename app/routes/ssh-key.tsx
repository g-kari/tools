  ...
  head: () => ({
    meta: [
      ...
      { name: 'twitter:title', content: 'SSH鍵生成 | Web ツール集' },
      {
        ...
        content:
          'RSA/ECDSA鍵ペアをブラウザ内で生成。秘密鍵は外部に送信されません。',
      },
    ],
  }),
    ...
    <>
      <div className="tool-container">
        ...
        <div className="ssh-key-warning" role="note">
          <span className="ssh-key-warning-icon" aria-hidden="true">🔒</span>
          <span>
            鍵ペアはブラウザ内（SubtleCrypto API）で生成されます。秘密鍵は外部のサーバーに送信されません。
          </span>
        </div>
        ...
        <div className="converter-section">
          ...
          <div
            className="ssh-key-algo-selector"
            role="group"
            aria-label="鍵アルゴリズムを選択"
          >
                  ...
                  >
                    ...
                    <div className="ssh-key-output-row">
                      ...
                      <Button
                        variant="secondary"
                        onClick={() =>
                          handleCopy(keyPair.publicKeyOpenSsh, 'OpenSSH公開鍵')
                        }
