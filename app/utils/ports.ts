...
export const PORT_DATABASE: PortEntry[] = [
  ...
  },
  {
    ...
    protocol: "TCP/UDP",
    service: "Chargen",
    description: "Character Generator Protocol。文字ストリームを生成するテスト・診断用プロトコル。",
    category: "network",
  },
  {
    port: 53,
  ...
  },
  {
    ...
    protocol: "TCP",
    service: "NetBIOS / SMB",
    description: "NetBIOS セッションサービス。Windows ファイル共有（SMB/CIFS）の旧来の通信ポート。",
    category: "file",
  },
  {
    port: 445,
  ...
  },
  {
    ...
    protocol: "UDP",
    service: "IKE / IPSec",
    description: "Internet Key Exchange。IPSec VPN のセッション確立・鍵交換に使用（IKEv1/IKEv2）。",
    category: "security",
  },
  {
    port: 51820,
    protocol: "UDP",
    service: "WireGuard",
    description: "WireGuard VPN のデフォルトポート。シンプルで高速・安全なモダンVPNプロトコル。",
    category: "security",
  },
  ...
  // ─── データベース ───────────────────────────────────────────
  {
    ...
    description: "Microsoft SQL Server のデフォルトポート。SQL Server データベースへの接続に使用。",
    category: "database",
  },
  {
    port: 1521,
  ...
  },
  {
    ...
    description: "Apache Cassandra のネイティブ転送ポート（CQL）。分散型 NoSQL データベース。",
    category: "database",
  },
  {
    port: 27017,
  ...
  },
  {
    ...
    protocol: "TCP",
    service: "InfluxDB",
    description: "InfluxDB 時系列データベースの HTTP API ポート。IoT・監視データの保存に広く使用。",
    category: "database",
  },
