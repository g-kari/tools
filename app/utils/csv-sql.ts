 ...
 */
export function isCsvSqlError(result: SqlResult | CsvSqlError | ParsedCsv | CsvSqlError): result is CsvSqlError {
  return 'type' in result && ('parse' === (result as CsvSqlError).type || 'generate' === (result as CsvSqlError).type);
}
