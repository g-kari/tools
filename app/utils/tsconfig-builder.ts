...
export const TSCONFIG_CATEGORIES: TsConfigCategory[] = [
  {
    ...
    options: [
      ...
      },
      {
        key: "lib",
        label: "lib",
        description: "使用する組み込みライブラリの型定義。DOM API や ES の機能を有効にする",
        type: "list",
        defaultValue: [],
        choices: [
          "ES5",
    ...
    options: [
      {
        ...
        description: "CommonJS モジュールを ES モジュールとして import できるようにする（推奨）",
        type: "boolean",
        defaultValue: false,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        key: "skipLibCheck",
        label: "skipLibCheck",
        description: "型定義ファイル (.d.ts) の型チェックをスキップする。ビルド速度向上に有効",
        type: "boolean",
        defaultValue: false,
