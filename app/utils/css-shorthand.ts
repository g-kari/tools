...
export const SHORTHAND_DEFINITIONS: readonly ShorthandDefinition[] = [
  {
    ...
    expand: (values) =>
      expandBoxModel(["margin-top", "margin-right", "margin-bottom", "margin-left"], values),
    collapse: (props) =>
      collapseBoxModel(["margin-top", "margin-right", "margin-bottom", "margin-left"], props),
  },
  {
    name: "padding",
    ...
    expand: (values) =>
      expandBoxModel(["padding-top", "padding-right", "padding-bottom", "padding-left"], values),
    collapse: (props) =>
      collapseBoxModel(["padding-top", "padding-right", "padding-bottom", "padding-left"], props),
  },
  {
    name: "border-radius",
 ...
 */
export function expandShorthand(propertyName: string, value: string): LonghandProperty[] | null {
